@Scenario-CME-600-3
Feature: Traditional Deal Smoke Test Booking via OBS: US-57648

	@TC-57654
	Scenario Outline: Application Activity
		Given Generating new test data "<testDataFilePath>" for Association "019" in Environment "FBLDATO"
		...
		Then User adds <2> Facilities and continues to add collateral
		...
		Examples:
			|testDataFilePath							 				|
			|src\\test\\resources\\testData\\Regression\\CME-600-3.xlsm	|
