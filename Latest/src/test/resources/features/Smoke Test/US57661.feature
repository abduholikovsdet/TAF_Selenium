...
Feature: CFC Traditional Deal Smoke Test: US-57661
	...
	Scenario Outline: Application Activity
		...
		And User continues to Route screen and routes the deal to "Traditional Due Diligence" to "Vaishnavi Venkatesh"
		Examples:
			|testDataFilePath											|
	...
	Scenario: Due Diligence Activity
		...
		And User continues to Route screen and routes the deal to "Pre-Decision Review" to "Vaishnavi Venkatesh"
	...
	Scenario: Pre Decision Review Activity
		...
		And User continues to Route screen and routes the deal to "Credit Decision" to "Vaishnavi Venkatesh"
	...
	Scenario: Credit Decision Activity
		...
		And User continues to Route screen and routes the deal to "Credit Approved" to "Vaishnavi Venkatesh"
	...
	Scenario: Credit Approved Activity
		...
		And User continues to Route screen and routes the deal to "Pending - Pre-Closing" to "Vaishnavi Venkatesh"
	...
	Scenario: Pre-Closing Activity
		...
		And User continues to Route screen and routes the deal to "Pre-Closing Doc Review" to "Vaishnavi Venkatesh"
	...
	Scenario: Pre Closing Doc Review Activity
		...
		And User continues to DDT screen and assigns Status to "Completed"
		And User continues to Route screen and routes the deal to "Closing - Doc Execution" to "Vaishnavi Venkatesh"
	...
	Scenario: Closing Doc Execution Activity
		...
		And User continues to DDT screen and assigns Status to "Completed"
		And User continues to Route screen and routes the deal to "Closing - Fund/Book" to "Vaishnavi Venkatesh"
	...
	Scenario: Closing Fund/Book Activity
		...
		And User continues to DDT screen and assigns Status to "Completed"
		And User continues to Route screen and routes the deal to "Post-Closing" to "Vaishnavi Venkatesh"
	...
	Scenario: Post-Closing Activity
		...
		And User continues to DDT screen and assigns Status to "Completed"
		And User continues to Route screen and routes the deal to "Complete" to "Padmini Batchu"
