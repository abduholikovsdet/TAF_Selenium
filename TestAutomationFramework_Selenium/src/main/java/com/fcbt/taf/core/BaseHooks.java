...
public class BaseHooks {
    ...
    public void beforeScenarioBaseHook(Scenario scenario) {
        ...
        DriverManager.initializeDriver(SystemConstants.BROWSER, SystemConstants.BROWSER_VERSION,
