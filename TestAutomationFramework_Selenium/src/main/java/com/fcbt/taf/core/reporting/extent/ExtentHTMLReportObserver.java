package com.fcbt.taf.core.reporting.extent;
...
import com.fcbt.taf.core.reporting.HTMLReportObserver;
import com.fcbt.taf.core.reporting.MessageType;
...
public class ExtentHTMLReportObserver implements HTMLReportObserver {
    ...
    public synchronized void setUp() {
        ExtentSparkReporter htmlReporter = new ExtentSparkReporter(OUTPUT_DIRECTORY + HTML_REPORT_NAME);
    ...
    public synchronized void info(String message, Throwable throwable) {
        getTest().createNode("My Step").info(message);
